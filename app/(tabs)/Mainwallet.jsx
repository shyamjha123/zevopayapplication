...
//   // const handleEmojiPress = (emoji, itemId) => {
//   //   triggerHaptic();
//   //   setSelectedEmojis((prev) => {
//   //     if (prev[itemId] === emoji) {
//   //       return { ...prev, [itemId]: null };
//   //     } else {
//   //       if (emoji === '👀') {
//   //         Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
//   //       }
//   //       return { ...prev, [itemId]: emoji };
//   //     }
//   //   });

//   //   // Close emoji picker only for this card
//   //   setShowEmojisId(null);
//   // };

//   const handleEmojiPress = (emoji, itemId) => {
//     if (emoji === '👀') {
//       Haptics.selectionAsync(); // faster, smoother
//     } else {
...
//             {/* ✅ Emoji display logic */}
//           {selectedEmoji && (
//             <TouchableOpacity onPress={() => handleEmojiPress(selectedEmoji, item.id)}>
...
//                 <TouchableOpacity key={index} onPress={() => handleEmojiPress(emoji, item.id)}>
...
const Mainwallet = () => {
  ...
  //     // 3. Hide emoji picker UI
  //     setShowEmojisId(null);
  //     console.log(showEmojisId, "showEmojisId")

  //     // 4. PUT request to update emoji
  ...
  //         'Authorization': `Bearer ${token}`,  // token from AsyncStorage
  //       },
  //       body: JSON.stringify({
  //         id: itemId,
  //         type: modetype,
